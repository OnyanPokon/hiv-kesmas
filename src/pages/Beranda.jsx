  ...
  return (
    <>
      <section className="bg-slate-100">
        <div className="grid max-w-screen-xl items-center min-h-screen px-6 py-24 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-cent er lg:col-span-7">
            <h1 className="max-w-2xl mb-6 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-5xl">
      ...
      <section className="bg-color-info-500">
        <div className="max-w-screen-xl mx-auto px-6 py-24 flex items-center gap-x-6">
          ...
          <div className="flex flex-col gap-y-2 w-full">
            <p className="text-white font-extrabold text-4xl">Gejala HIV/AIDS</p>
            ...
            <Button className="w-fit mt-4" pill color="primary" size="lg">
              Baca Selengkapnya
            </Button>
          </div>
          <div />
      ...
      <section className="bg-white ">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-24 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-color-info-500">Apa yang Kami Tawarkan</h2>
            <p className="text-gray-500 sm:text-xl dark:text-gray-400">Fitur yang mungkin dapat membantu kamu mencegah penyebaran HIV </p>
          </div>
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            ...
            <div>
              ...
              <Button color="info" pill className="mt-4">
                Selengkapnya
              </Button>
            </div>
            <div>
