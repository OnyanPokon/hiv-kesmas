    ...
    <>
      <section className="bg-slate-100">
        <div className="grid max-w-screen-xl items-center min-h-screen px-8 py-24 pt-32 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div data-aos="fade-up" className="mr-auto place-self-cent er lg:col-span-6">
          ...
          <div className="mt-16 lg:mt-0 lg:col-span-6 lg:flex justify-center">
            <img
              src="/illustration/Frame 15.png"
              alt="mockup"
